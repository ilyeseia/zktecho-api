...
try:
    ...
    for attendance in conn.live_capture():
        if attendance is None:
            ...
            channel.queue_declare(queue='pointeuse6')
            channel.basic_publish(exchange='', routing_key='pointeuse6', body= json.dumps(serialize_attendances))
            connection.close()  
